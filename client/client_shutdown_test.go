...
func TestClientImpl_Shutdown_Basic(t *testing.T) {
...
func TestClientImpl_Shutdown_ServerId(t *testing.T) {
...
func TestClientImpl_Shutdown_DiffStatusPort(t *testing.T) {
	c := newClientImpl(&Options{
		Port:       testShutdownPort,
